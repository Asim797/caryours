<template>
    <section class="position-relative pb-lg-5">
        <img
            :src="base_url + `/assets/web/images/about-right.png`"
            alt=""
            class="img-fluid noti-right"
        />
        <img
            :src="base_url + `/assets/web/images/about-left.png`"
            alt=""
            class="img-fluid noti-left"
        />
        <div class="container">
            <div class="row">
                ...
                <div class="col-12">
                    <div
                        class="d-flex align-items-start noti-div mt-2"
                        v-for="notification in notifications.data"
                        :key="notification.id"
                    >
                        <img
                            :src="base_url + `/assets/web/images/noti-img.png`"
                            alt=""
                            class="mr-3"
                        />
                        <div>
                            <p>{{ JSON.parse(notification.data).title }}</p>
                            <label for="" class="noti-lbl">{{
...
export default {
    ...
    computed: {
        ...mapState("store", ["notifications", "search", "bell_notifications"]),
    },
    components: {
        // EmployeeTable,
    },
