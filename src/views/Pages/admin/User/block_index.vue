                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-right">
                                <router-link
                                    ...
                                    class="greenn-btn d-inline-block"
                                    >Active Users</router-link
                                >
                            </div>
                        </div>
                        <h2 class="sub-heading mt-2 ml-1">
...
<script>
const UserTable = () => import("./components/BlockTable.vue");
