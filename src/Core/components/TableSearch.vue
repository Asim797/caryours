    ...
    <div class="d-flex align-items-end col-md-12 col-sm-12">
            ...
            >
                <label class="d-flex"
                    ...
                    <select
                        ...
                        class="form-control form-control-sm custom-datatable-vue"
                    >
        ...
        <div class="col-md-6 col-sm-12">
            <div
                ...
                class="dataTables_filter for-search w-100"
            >
                <label
                    ><input
                        v-model="searchValue"
                        spellcheck="true"
                        type="search"
                        class="site-input border gj-textbox-md custom-search-vue"
